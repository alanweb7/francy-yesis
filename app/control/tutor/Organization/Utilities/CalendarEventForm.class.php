...
class CalendarEventForm extends TWindow
{
    ...
    public function __construct()
    {
        ...
        $this->form->addFields( [new TLabel('Etiqueta:')], [$color] );
        $this->form->addFields( [new TLabel('início:')], [$start_date, $start_hour, ':', $start_minute] );
        $this->form->addFields( [new TLabel('Final:')], [$end_date, $end_hour, ':', $end_minute] );
