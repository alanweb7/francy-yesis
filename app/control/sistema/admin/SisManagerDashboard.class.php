 ...
 */
class SisManagerDashboard extends TPage
{
    /**
     * Class constructor
     * Creates the page
    ...
    function __construct()
    {
        ...
        try {
            $html = new THtmlRenderer('app/resources/sis_manager_dashboard.html');
            ...
            $indicator1->enableSection('main', ['title' => 'Verificados',   'icon' => 'regular fa-clock',       'background' => 'orange', 'value' => SystemUser::count()]);
            $indicator2->enableSection('main', ['title' => 'Agendado',      'icon' => 'calendar',      'background' => 'blue',   'value' => SystemGroup::count()]);
            $indicator3->enableSection('main', ['title' => 'A confirmar',   'icon' => 'sync', 'background' => 'purple', 'value' => SystemUnit::count()]);
            $indicator4->enableSection('main', ['title' => 'Cadastrados',   'icon' => 'solid fa-check',       'background' => 'green',  'value' => SystemProgram::count()]);
