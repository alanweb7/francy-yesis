...
/**
 * SystemNotificationFormList Form List
 * @author  <your name here>
 */
class CadastroTipoAtendimentosDataGridViewForm extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        // $column_subject = new TDataGridColumn('subject', 'Subject', 'left');
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for SystemNotification
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            $object = new SisTipoAtendimento($key, FALSE); // instantiates the Active Record
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new SisTipoAtendimento();  // create an empty object
            $object->fromArray( (array) $data); // load the object with data
            $object->group_id = TSession::getValue('userunitid'); // save the object
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                $key = $param['key'];  // get the parameter $key
                TTransaction::open('sistema'); // open a transaction
                $object = new SisTipoAtendimento($key); // instantiates the Active Record
