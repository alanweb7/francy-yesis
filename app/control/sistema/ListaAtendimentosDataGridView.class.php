 ...
 */
class ListaAtendimentosDataGridView extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('SisAtendimentos');   // defines the active record
        ...
        $this->listPessoasAtendimentos = $this->getPessoasAtendidas();

        $nome->addItems(
            $this->listPessoasAtendimentos
        );
        ...
        $colums = [
            ...
            'pessoa_id' => new TDataGridColumn('sispessoas->nome', 'Nome', 'left', '40%'),
            'fone1' => new TDataGridColumn('sispessoas->fone1', 'Contato', 'left'),
            'cidade' => new TDataGridColumn('cidade', 'Cidade', 'left'),
            'created_date' => new TDataGridColumn('created_date', 'Data', 'left'),
