 ...
 */
class ListaAssessoriaDataGridView extends TPage
{
    ...
    public function __construct()
    {
        ...
        // $this->setActiveRecord("SisAssessoriaVw");   // defines the active record
        $this->setActiveRecord("SisMultiplicadores");   // defines the active record
        ...
        // $criteria_default->add(new TFilter('segmento', '=', 2)); //liderancas
        ...
        // header actions
        $newRegister = new TActionLink('Novo Cadastro', new TAction(array('CadastroSisPessoaGeralForm', 'onLoad'), ['type_register'=> 2]), 'green', 10, null, 'fa:plus-circle');
