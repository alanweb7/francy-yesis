 ...
 */
class SisListaRegioesParaGridView extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('SisLocaisRegioes');   // defines the active record
        ...
        $nome = new TDBCombo('municipio', 'sistema', 'SisLocaisRegioes', 'id', 'municipio', null);
        ...
        $colums = [
            ...
            'municipio' => new TDataGridColumn('municipio', 'Município', 'left', '40%'),
            'regiao' => new TDataGridColumn('regiao', 'Região', 'left', '40%'),
        ];
