 ...
 */
class SisLevelUserForm extends TWindow
{
    private $form;
    ...
    public function __construct()
    {
        ...
        $group_permission = new TCombo('meta_key');
        $name->forceUpperCase();

        $levelOptions = [
            0 => 'NENHUMA AÇÃO NO SISTEMA',
            1 => 'VISUALIZAR',
            2 => 'EDITAR',
            3 => 'CRIAR / EDITAR',
        ...
        $group_permissionOptions = [
            "user_permission"   => 'Permissões de Usuário',
            "group_category"    => 'Grupo de Categoria'
        ];

        $group_permission->addItems($group_permissionOptions);
        $group_permission->setDefaultOption("Selecione");
      
        $row =  $this->form->addFields(
            [new TLabel('Categoria do Campo')],
            [$group_permission]
        );
    ...
    public function onSave($param)
    {
        try {
            ...
            if(!$object->meta_key) $object->meta_key = "general_field";
