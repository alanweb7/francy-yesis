 ...
 */
class ListaColaboradoresDataGridView extends TPage
{
    ...
    public function __construct()
    {
        ...
        // $criteria_default->add(new TFilter('segmento', '=', 8)); //Colaboradores
        ...
        $action3 = new TDataGridAction(['CadastroSisAtendimentoForm', 'onLoad'], ['id' => '{id}', 'origem' => __CLASS__]);

        $this->datagrid->addAction($action1, _t('Edit'),   'far:edit blue');
        $this->datagrid->addAction($action2, _t('Delete'), 'far:trash-alt red');
        $this->datagrid->addAction($action3,"Atendimento", 'fas:user-md grenn');
        ...
        // header actions
        $newRegister = new TActionLink('Novo Cadastro', new TAction(array('CadastroSisPessoaGeralForm', 'onLoad'), ['type_register'=> 8]), 'green', 10, null, 'fa:plus-circle');
