 ...
 */
class CadastroAssessoriaForm extends TWindow
{
    private $form;
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('CADASTRAR ASSESSORIA');
        ...
        $level = new TDBCombo('segmento', 'sistema', 'SisGeneralField', 'id', 'name', 'name ASC');
        ...
        $row->layout = ['col-sm-2 control-label', 'col-sm-3', 'col-sm-2 control-label', 'col-sm-3'];
    ...
    public function onSend($param)
    {
        try {
            ...
            $object->level_id = 7;
            $object->group_id = serialize(TSession::getValue('usergroupids'));
          

            $object->store(); // store the object

            new TMessage('info', 'Informações salvas com Sucesso!', new TAction(array('ListaAssessoriaDataGridView', 'onReload')));
